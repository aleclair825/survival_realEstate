...
First, we fit a Kaplan-Meier curve for TOM by distance from the nearest school ($Figure \hspace{0.1cm} 1 $). In order to do this, we identify the closest 50% of homes as "near" and the farthest 50% of homes as "far."
