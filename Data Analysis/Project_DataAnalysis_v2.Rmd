...
### 3a. Crime Category 2 + Listed at Price + School Distance
...
### 3b. Full Model without Interaction Term (Original)
```{r}
...
## 4. Covariate Comparisons 

### 4a. (prdiff) vs (`prdiff` + `schdist`)
...
### 4b. (`prdiff` + `schdist`) vs. (`prdiff` + `schdist` + `sqft`)
...
### 4c. (null) vs (`schdist`) - Victor Suggested
